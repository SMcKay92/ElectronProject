...
{
    let themeCss = fs.readFileSync("./halloweenTheme.css").toString();
...
function ChristmasTheme(){
    let themeCss =  fs.readFileSync("./christmasTheme.css").toString();
  settings.set('theme', themeCss);
    mainWindow.webContents.insertCSS(themeCss);
    console.log(themeCss);
}

function EasterTheme()
{
    let themeCss = fs.readFileSync("./easterTheme.css").toString();
    console.log(themeCss);
    settings.set('theme', themeCss);
    mainWindow.webContents.insertCSS(themeCss);
